...
import 'package:eccommerceapp/views/shared_widgets/icon_with_texts_widget.dart';
import 'package:eccommerceapp/controllers/search_controller.dart';
import 'package:eccommerceapp/models/item_model.dart';
import 'package:eccommerceapp/views/shared_widgets/custom_grid_view_with_title.dart';
...
class _MoreItemsScreenState extends State<MoreItemsScreen> {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Scaffold(appBar: buildAppBar(), body: body()),
    );
  }
        ...
        child: AppBar(
          ...
          title: TextField(
            ...
            onChanged: (value) {
              ...
              _searchController
                  .searchItem(_searchController.searchItemName.value);
            },
          ),
          centerTitle: true,
          leading: Padding(
